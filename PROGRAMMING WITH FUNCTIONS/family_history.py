...
def print_death_age(people_dict):
    ...
    for key in people_dict.keys():
        print(f'Name: {people_dict[key][0]}\nDeath: {people_dict[key][3]}\n')
...
def count_genders(people_dict):
    ...
    print(f'There are {female} females inside the list.\nThere are {male} males inside the list.')
...
def print_marriages(marriages_dict, people_dict):
    ...
    """
    for key in people_dict.keys():
        for val in marriages_dict.values():
            if key == val[1]:
                print(f'Husband: {people_dict[val[0]][0]}\nAge: {val[2]-people_dict[val[0]][2]}\nWife: {people_dict[val[1]][0]}\nAge: {val[2]-people_dict[val[1]][2]}\nMarriage Year: {val[2]}\n')
